        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PlannedAmountOfMoney = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    TotalAmountOfMoney = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpenseVolume = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    ExpenseDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    BudgetId = table.Column<int>(type: "int", nullable: false),
                    ExpenceCategoryId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IncomeVolume = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
